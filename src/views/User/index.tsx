...
export default function User() {
  ...
  const UserTop = () => {
    ...
    //    effect: user email path variable 변경 시 실행 할 함수   //
    useEffect(() => {
      if (!userEmail) return;
      getUserRequest(userEmail).then(getUserResponse);
        ...
        <div className='user-top-container'>
          ...
          <div className='user-top-info-box'>
            <div className='user-top-info-nickname-box'>
              ...
              <>
              {isNicknameChange ? 
              <input className='user-top-info-nickname-input' type='text' size={changeNickname.length + 8} value={changeNickname} onChange={onNicknameChangeHandler} /> :
